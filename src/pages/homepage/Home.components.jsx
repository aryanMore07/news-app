                    ...
                    <div className='card-div col-md-6 col-lg-3 col-sm-1'>
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="news-one" className="btn btn-primary">Go to News</Link>
                            </div>
                        </div>
                    </div>
                    <div className='card-div col-md-6 col-lg-3 col-sm-1'>
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to='news-two' className="btn btn-primary">Go to News</Link>
                            </div>
                        </div>
                    </div>
                    <div className='card-div col-md-6 col-lg-3 col-sm-1'>
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="news-three" className="btn btn-primary">Go to News</Link>
                            </div>
                        </div>
                    </div>
                    <div className='card-div col-md-6 col-lg-4 col-sm-1'>
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="news-four" className="btn btn-primary">Go to News</Link>
                            </div>
                        </div>
                    </div>
                    <div className='card-div col-md-6 col-lg-4 col-sm-1'>
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                <Link to="news-five" className="btn btn-primary">Go to News</Link>
                            </div>
                        </div>
                    </div>
                </div>
